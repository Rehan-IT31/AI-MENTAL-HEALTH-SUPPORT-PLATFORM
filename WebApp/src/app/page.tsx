...
const HeroSection: React.FC = () => {
  ...
  return (
    <div
      className={` selection:bg-teal-200 selection:text-teal-950 min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-950
 relative overflow-hidden ${ClashDisplay.className}`}
    >
      ...
      <div className="w-[90%] max-w-[1440px] min-h-[600px] bg-slate-900 mx-auto rounded-xl flex items-center justify-center flex-col relative mt-10 px-5 py-5 md:px-30">
        <h1 className="relative flex items-center justify-center text-white text-5xl text-center ">
          ...
          {
            "MindMate is an intelligent, well-crafted solution that empowers therapists and clients to achieve better outcomes together."
          }
        </h1>
        <p className="w-full flex flex-col text-white text-lg mt-4 text-right">
          <span className="text-xl text-[#00FF8C]">Dr.Lyketsos</span>
          <span>Psychiatrist</span>
          <span>McLean Hospital</span>
        </p>
      </div>
